...
class SingleView extends React.Component<WithTranslation> {
  state = {
    ...
    flotOptions: {
      ...
      tooltip: true,
      tooltipOpts: {
        content: (label: any, x: any, y: any) => x + " : " + y,
      },
      xaxis: {
        tickColor: "#fcfcfc",
        mode: "categories",
      ...
      yaxis: {
        min: 0,
        max: 150, // optional: use it for a clear representation
        tickColor: "#eee",
        //position: 'right' or 'left',
        tickFormatter: (v: any) => v /* + ' visitors'*/,
      },
      shadowSize: 0,
    },
    dropdownOpen: false,
      ...
      <ContentWrapper>
        ...
        <Row>
          <Col xs={12} className="text-center">
            <h2 className="text-thin mb-4">ANS CENTER API MANAGEMENT PAGE</h2>
          </Col>
        </Row>
        <br />
        {/* START cards box */}
              ...
              <Col xl={8}>
                <div className="card card-default">
                  <div className="card-header">
                    ...
                    <div className="card-title">Latest Post Comments</div>
                  </div>
                  {/* START list group */}
